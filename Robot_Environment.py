...
class CartPoleEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.rotation_limitation = 25 * 100  # degree * rotation_step resolution
    ...
    def reset1(self, randomness=False):
        self.state_obj = self.np_random.uniform(
            low=-0.00, high=0.00, size=(3,))
        self.steps_beyond_done_obj = None
        self.step_count = 0
    ...
    def render1(self, mode='human'):
        ...
        if self.viewer is None:
            ...
            larm = rendering.Image(
                'larm.jpg', self.armwidth, self.armheight)
            ...
            rarm = rendering.Image(
                'rarm.jpg', self.armwidth, self.armheight)
            ...
            obj1 = rendering.Image(
                'Object_Keyboard.jpg', self.objwidth, self.objheight)
        ...
        disR = math.tanh(np.radians((orientation_state / 100))
                         ) * (self.objwidth / 2)
